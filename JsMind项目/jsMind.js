...
!(function (e, t) {
  ...
  const i = {
    ...
    n = { show: 1, resize: 2, edit: 3, select: 4 },
    o = { debug: 1, info: 2, warn: 3, error: 4, disable: 9 };
  var s = function () {};
  let a =
    "undefined" == typeof console
      ? { level: s, log: s, debug: s, info: s, warn: s, error: s }
      : {
          level: function (e) {
      ...
      e
        ? "number" == typeof t
          ? (void 0 === d && (d = !0),
            ...
            (this.children = []),
            (this._data = {}))
          : a.error("invalid node index")
        : a.error("invalid node id");
    }
    get_location() {
  ...
  class _ {
    ...
    get_node(e) {
      return e in this.nodes
        ? this.nodes[e]
        : (a.warn("the node[id=" + e + "] can not be found"), null);
    }
    set_root(e, t, i) {
      return null == this.root
        ? ((this.root = new h(e, 0, t, i, !0)),
          this._put_node(this.root),
          this.root)
        : (a.error("root node is already exist"), null);
    }
    add_node(e, t, n, o, s, r, d) {
      if (!h.is_node(e))
        return a.error("the parent_node " + e + " is not a node."), null;
      var l = new h(t, d || -1, n, o, !1, e, e.direction, r);
      return (
        e.isroot && (l.direction = s || i.right),
        this._put_node(l)
          ? (e.children.push(l), this._update_index(e))
          : (a.error(
              "fail, the node id '" + l.id + "' has been already exist."
            ),
            (l = null)),
        l
      );
    ...
    insert_node_before(e, t, i, n, o) {
      if (!h.is_node(e))
        return a.error("the node_before " + e + " is not a node."), null;
      var s = e.index - 0.5;
    ...
    get_node_before(e) {
      if (!h.is_node(e)) {
        ...
        return t
          ...
          : (a.error("the node[id=" + e + "] can not be found."), null);
      }
    ...
    insert_node_after(e, t, i, n, o) {
      if (!h.is_node(e))
        return a.error("the node_after " + e + " is not a node."), null;
      var s = e.index + 0.5;
      return this.add_node(e.parent, t, i, n, o, !0, s);
    }
    get_node_after(e) {
    ...
    move_node(e, t, i, n) {
      return h.is_node(e)
        ...
        : (a.error("the parameter node " + e + " is not a node."), null);
    }
    ...
    _move_node(e, t, n, o) {
      if (e && n) {
        ...
        if (h.inherited(e, s))
          return a.error("can not move a node to its children"), null;
        if (e.parent.id != n) {
    ...
    remove_node(e) {
      if (!h.is_node(e))
        return a.error("the parameter node " + e + " is not a node."), !1;
    ...
    _put_node(e) {
      return e.id in this.nodes
        ? (a.warn("the node_id '" + e.id + "' has been already exist."), !1)
        : ((this.nodes[e.id] = e), !0);
    }
    _update_index(e) {
      if (e instanceof h) {
  ...
  const u = {
      ...
      _build_node: function (e) {
        ...
        if (e instanceof h) {
          ...
          if (
            (e.parent &&
              e.parent.isroot &&
              (n.direction = e.direction == i.left ? "left" : "right"),
            null != e.data)
          ) {
            var o = e.data;
    ...
    node_array: {
      example: {
        ...
        format: "node_array",
        data: [{ id: "root", topic: "jsMind Example", isroot: !0 }],
      },
      get_mind: function (e) {
        var t = u.node_array,
          i = new _();
      ...
      _extract_subnode: function (e, t, n) {
        for (
          var o = u.node_array, s = n.length, a = null, r = null, d = 0;
          s--;
      ...
      _array_node: function (e, t) {
        ...
        if (e instanceof h) {
          ...
          if (
            ...
            e.parent &&
              e.parent.isroot &&
              (o.direction = e.direction == i.left ? "left" : "right"),
            null != e.data)
          ) {
            var s = e.data;
    ...
    freemind: {
      ...
      _build_map: function (e, t) {
        ...
        e.parent &&
          e.parent.isroot &&
          (o = e.direction === i.left ? "left" : "right"),
          t.push("<node"),
          t.push('ID="' + e.id + '"'),
          o && t.push('POSITION="' + o + '"'),
          t.push('TEXT="' + e.topic + '">'),
    ...
    text: {
      example: {
        meta: { name: "jsMind text example", author: t, version: e },
        format: "text",
        data: "Text Example\n node1\n  node1-sub\n  node1-sub\n node2",
      },
      _line_regex: /\s*/,
  ...
  class v {
    ...
    reset() {
      a.debug("layout.reset"), (this.bounds = { n: 0, s: 0, w: 0, e: 0 });
    }
    ...
    _layout_direction_root() {
      ...
      if (((t.direction = i.center), (t.side_index = 0), this.isside))
        ...
        s = o;
        for (var a = null; s--; )
          (a = n[s]).direction == i.left
            ? this._layout_direction_side(a, i.left, s)
            : this._layout_direction_side(a, i.right, s);
      }
    }
    ...
    layout_offset() {
      ...
      for (var n = e.children, o = n.length, s = [], a = [], r = null; o--; )
        (r = n[o])._data.layout.direction == i.right
          ? a.unshift(r)
          : s.unshift(r);
      (t.left_nodes = s),
        (t.right_nodes = a),
    ...
    _layout_offset_subnodes(e) {
      for (
        ...
        (a = (o = e[n])._data.layout),
          ...
          (a.offset_y = r - s / 2),
          (a.offset_x =
            this.opts.hspace * a.direction +
            (d.view.width * (d.layout.direction + a.direction)) / 2),
    ...
    get_expander_point(e) {
      var t = this.get_node_point_out(e),
        n = {};
      return (
        e._data.layout.direction == i.right
          ? (n.x = t.x - this.opts.pspace)
          : (n.x = t.x),
  ...
  class g {
    ...
    get_binded_nodeid(e) {
      ...
      return "jmnodes" == t || "body" == t || "html" == t
        ? null
        : "jmnode" == t || "jmexpander" == t
    ...
    init_nodes() {
      ...
      for (var i in (this.e_nodes.appendChild(t), e))
    ...
    update_node(e) {
      ...
      if (
        (e.topic &&
          (this.opts.support_html ? r.h(i, e.topic) : r.t(i, e.topic)),
    ...
    edit_node_end() {
      if (null != this.editing_node) {
        ...
        (t.style.zIndex = "auto"),
          ...
          d.text.is_empty(i) || e.topic === i
            ? this.opts.support_html
              ? r.h(t, e.topic)
              : r.t(t, e.topic)
    ...
    _show() {
      this.graph.set_size(this.size.w, this.size.h),
        ...
        this.show_nodes(),
        this.show_lines(),
        this.jm.invoke_event_handle(n.resize, { data: [] });
    }
    zoomIn() {
    ...
    _center_root() {
      ...
      this.size.h > t &&
        (this.e_panel.scrollTop = (this.size.h * this.actualZoom - t) / 2);
    }
    show(e) {
      a.debug("view.show"),
        this.expand_size(),
    ...
    show_lines() {
      ...
      for (var a in e)
        (t = e[a]).isroot ||
          ("visible" in t._data.layout && !t._data.layout.visible) ||
  ...
  class j {
    ...
    constructor(t) {
      (j.current = this),
        (this.options = (function (e) {
          var t = {};
          if ((d.json.merge(t, l), d.json.merge(t, e), !t.container))
            throw new Error(
    ...
    mousedown_handle(e) {
      if (this.options.default_event_handle.enable_mousedown_handle) {
        ...
        i
          ? "jmnode" == t.tagName.toLowerCase() && this.select_node(i)
          : this.select_clear();
      }
    }
    click_handle(e) {
    ...
    begin_edit(e) {
      if (!h.is_node(e)) {
        ...
        return t
          ? this.begin_edit(t)
          : (a.error("the node[id=" + e + "] can not be found."), !1);
      }
      this.get_editable()
    ...
    toggle_node(e) {
      if (!h.is_node(e)) {
        ...
        return t
          ? this.toggle_node(t)
          : void a.error("the node[id=" + e + "] can not be found.");
      }
      e.isroot ||
      ...
      (this.mind = this.data.load(t)),
        this.mind
          ? (a.debug("data.load ok"),
            ...
            this.invoke_event_handle(n.show, { data: [e] }))
    ...
    update_node(e, t) {
      if (this.get_editable())
        if (d.text.is_empty(t)) a.warn("fail, topic can not be empty");
          ...
          if (i) {
            if (i.topic === t)
              return a.info("nothing changed"), void this.view.update_node(i);
            (i.topic = t),
    ...
    find_node_before(e) {
      ...
      if (e.parent.isroot)
        for (
          var n = e.parent.children, o = null, s = null, r = 0;
          r < n.length;
          r++
        )
          (s = n[r]),
            e.direction === s.direction && (e.id === s.id && (i = o), (o = s));
    ...
    find_node_after(e) {
      ...
      if (e.parent.isroot) {
        for (
          var n = e.parent.children, o = !1, s = null, r = 0;
          r < n.length;
          r++
        )
